...
#define LM75A_DEFAULT_ADDRESS      0x48;   /**< Address is configured with pins A0-A2, 8 bit address, 0x48 to 0x4F */
...
private:
	// I2C timing constant
	static constexpr uint32_t LM75A_TO_I2C_DELAY        = 50;        /**< Timeout for I2C comms, mS */
	// LM75A Register
	static constexpr uint8_t LM75A_REGISTER_TEMP        = 0;         /**< Temperature register (read-only) */
	static constexpr uint8_t LM75A_REGISTER_CONFIG      = 1;         /**< Configuration register */
	static constexpr uint8_t LM75A_REGISTER_THYST       = 2;         /**< Hysteresis register */
	static constexpr uint8_t LM75A_REGISTER_TOS         = 3;         /**< OS register */
	static constexpr uint8_t LM75A_REGISTER_PRODID      = 7;         /**< Product ID register - Only valid for Texas Instruments */

	static constexpr uint8_t LM75_CONF_OS_COMP_INT      = 1;         /**< OS operation mode selection */
	static constexpr uint8_t LM75_CONF_OS_POL           = 2;         /**< OS polarity selection */
	static constexpr uint8_t LM75_CONF_OS_F_QUE         = 3;         /**< OS fault queue programming */
};
