...
#define AHT10_ADDRESS_0X38         0x38  /**< I2C address no.1 for AHT10/AHT15/AHT20, adress pin connect to GND */
#define AHT10_ADDRESS_0X39         0x39  /**< I2C address no.2 for AHT10 only, adress pin connect to Vcc */
...
/*! @brief Enumeration for ASAIR I2C Sensors type*/
enum ASAIR_I2C_SENSOR_e : uint8_t{
	AHT10_SENSOR = 0x00, /**< AHT10 sensor */
    AHT15_SENSOR = 0x01, /**< AHT15 sensor */
    AHT20_SENSOR = 0x02  /**< AHT20 sensor */
};

/*! 
    @class LIB_AHTXX
    @brief Library for Aosong ASAIR AHT10, AHT15, AHT20 Digital Humidity & Temperature Sensor
 */
class LIB_AHTXX
{
private:
    i2c_inst_t *i2c; /**< I2C instance pointer */
    uint8_t  _address; /**< Sensor I2C address */
    uint8_t _SDataPin; /**< Serial data pin */
    uint8_t _SClkPin; /**< Serial clock pin */
    uint16_t _CLKSpeed = 100; /**< I2C bus speed in khz typically 100-400 */
    ASAIR_I2C_SENSOR_e _sensorName; /**< Sensor type */
    uint8_t  _rawDataBuffer[6] = {AHT10_ERROR, 0, 0, 0, 0, 0}; /**< Raw data buffer */
    uint8_t  _statusByte = 0; /**< Status byte */
    int16_t  returnValue = 0; /**< Return value for I2C functions */
